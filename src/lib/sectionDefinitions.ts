    ...
    sections: [
      {
        ...
        fields: [
          ...
          { fieldKey: "cta_href", label: "Primary Button Link", type: "url", defaultValue: "/booking#pabau-iframe" },
      ...
      },
      {
        ...
        fields: [
          ...
          { fieldKey: "link_text", label: "View All Link Text", type: "text", defaultValue: "Explore Services" },
        ],
        media: [
      ...
      },
      {
        ...
        fields: [
          ...
          { fieldKey: "cta_href", label: "Button Link", type: "url", defaultValue: "/booking#pabau-iframe" },
          { fieldKey: "secondary_text", label: "Secondary Link Text", type: "text", defaultValue: "Explore Services" },
          { fieldKey: "secondary_href", label: "Secondary Link URL", type: "url", defaultValue: "/services" },
        ],
        media: [],
